...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:variable name="default-font-family">Ubuntu, sans-serif</xsl:variable>
  ...
  <xsl:variable name="prismjs.token.comment.color">#aea79f</xsl:variable>
  <xsl:variable name="prismjs.token.punctuation.color">#555555</xsl:variable>
