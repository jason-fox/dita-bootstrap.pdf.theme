...
>
  ...
  <xsl:variable name="default-font-family">Open Sans, sans-serif</xsl:variable>
  ...
  <xsl:variable name="prismjs.background.color"><xsl:value-of select="$bootstrap-light"/></xsl:variable>
  <xsl:variable name="prismjs.token.comment.color">#999999</xsl:variable>
  <xsl:variable name="prismjs.token.punctuation.color">#666666</xsl:variable>
